...
2. To make sure your application is working fine and it creates the Genesis Block you can use POSTMAN to request the Genesis block:
    ![Request: http://localhost:8000/blocks/height/0 ](./assets/genesis-block.png)
3. Make your first request of ownership sending your wallet address:
    ![Request: http://localhost:8000/requestValidation ](./assets/request-validation.png)
4. Sign the message with your Wallet private key:
    ![Use the Wallet to sign a message](./assets/sign-message.png)
5. Submit your Star
     ![Request: http://localhost:8000/submitstar](./assets/submit-star.png)
6. Retrieve Stars owned by me
    ![Request: http://localhost:8000/blocks/<WALLET_ADDRESS>](./assets/starsOwned.png)
7. Tamper with a block in the blockchain
    ![Request: http://localhost:8000/tamperBlock](./assets/tamper-block.png)
8. Validate chain after tampering with block
    ![Request: http://localhost:8000/validateChain](./assets/validate-chain.png)